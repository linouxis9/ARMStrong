...
public class TextFieldTableCellFixed<S,T> extends TableCell<S,T> {
    ...
    public static <S,T> Callback<TableColumn<S,T>, TableCell<S,T>> forTableColumn(
        ...
        return list -> new TextFieldTableCellFixed<S,T>(converter);
    }
    ...
    @Override protected Skin<?> createDefaultSkin() {
        return new TableCellSkinFixed<S,T>(this);
    }
     ...
     */
    public TextFieldTableCellFixed() {
        this(null);
    }
     ...
     *      type T.
     */
    public TextFieldTableCellFixed(StringConverter<T> converter) {
